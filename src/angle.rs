...
pub enum Octant { _0, _1, _2, _3, _4, _5, _6, _7 }
...
impl AngleDeg {
	...
	pub fn is_oct0(self) -> bool { 0. <= self.0 && self.0 <= 45. }
	pub fn is_oct1(self) -> bool { 45. <= self.0 && self.0 <= 90. }
	pub fn is_oct2(self) -> bool { 90. <= self.0 && self.0 <= 135. }
	pub fn is_oct3(self) -> bool { 135. <= self.0 && self.0 <= 180. }
	pub fn is_oct4(self) -> bool { 180. <= self.0 && self.0 <= 225. }
	pub fn is_oct5(self) -> bool { 225. <= self.0 && self.0 <= 270. }
	pub fn is_oct6(self) -> bool { 270. <= self.0 && self.0 <= 315. }
	pub fn is_oct7(self) -> bool { 315. <= self.0 && self.0 <= 360. }
}
